...
def create_user(db: Session, user_data: UserCreate) -> User:
    ...
    if existing_user:
        raise HTTPException(status_code=400, detail="Email or username or phone number already registered !")
...
"""def update_user(db: Session, user_id: int, user_update: UserUpdate) -> type[User] | None:
